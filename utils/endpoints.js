 ...
 * ONLINE CLASS
 */
export const TEACHING_OLCLASSES = `/elearning/teaching/lessons`;
export const TEACHING_OLCLASSES_NEW = `/elearning/teaching/olclasses`;
...
export const TEACHING_OLCLASS_JOINED_STUDENTS = `elearning/teaching/olclass/joined/students`
