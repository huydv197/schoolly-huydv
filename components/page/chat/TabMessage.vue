                    ...
                    >
                      ...
                      <template #popover>
                        <ul class="ul-popover">
                          ...
                          <li class="link--dropdown__content__item">
                            <a @click="handleDeleteMessage(item.room_id, item.id)">Xóa tin</a>
                          </li>
                        </ul>
                      </template>
                    </v-popover>
...
export default {
  ...
  computed: {
    ...
    filterMessageList() {
      const dataMap = this.messagesList
        .map((item) => {
          const [tmpUser] =
            this.memberList &&
  ...
  methods: {
    ...
    handleDeleteMessage(room_id, message_id) {
      this.deleteMessage({ room_id, message_id }).then((result) => {
        console.log("result", result);
        if (!result.error) {
