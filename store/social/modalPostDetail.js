...
const actions = {
  ...
  async [actionTypes.MODAL_POST_DETAIL.GET_CHILD_COMMENT](
    { state, commit },
    { parentPostId, postId, commentId, fromId, size } = {}
  ) {
    try {
      const result = await this.$axios.$get(
        parentPostId
          ? `${ENDPOINT_POSTS}/${parentPostId}/children/${postId}/comments/${commentId}/comments`
  ...
  async [actionTypes.MODAL_POST_DETAIL.EDIT_CHILD_COMMENT](
    { state, commit },
    { parentPostId, postId, parentCommentId, commentId, model } = {}
  ) {
    try {
      const result = await this.$axios.$patch(
        parentPostId
          ? `${ENDPOINT_POSTS}/${parentPostId}/children/${postId}/comments/${parentCommentId}/comments/${commentId}`
  ...
  async [actionTypes.MODAL_POST_DETAIL.DELETE_CHILD_COMMENT](
    ...
    try {
      const result = await this.$axios.$delete(
        parentPostId
          ? `${ENDPOINT_POSTS}/${parentPostId}/children/${postId}/comments/${parentCommentId}/comments/${id}`
